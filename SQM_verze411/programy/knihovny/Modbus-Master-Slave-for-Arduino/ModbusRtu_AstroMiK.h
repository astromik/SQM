/**
 * @file 	ModbusRtu.h
 * @version     1.21 (doplneni "AstroMiK")
 * @date        2016.02.21
 *     2023.12.18  !!MIK-1!!- doplneni knihovny o zjisteni kodu posledni pozadovane funkce "getLastFunction()"
       2024.01.06  !!MIK-2!!- rozsireni bufferu z 64 bajtu na 90 bajtu
...
#define T35  5
//#define  MAX_BUFFER  64	//!< maximum size for the communication buffer in bytes        !!MIK-2!!
#define  MAX_BUFFER  90	//!< maximum size for the communication buffer in bytes          !!MIK-2!!
...
public:
    ...
    uint8_t getLastFunction();   //  Pro SLAVE - Vrati posledni funkci, ktera byla v zadosti odeslana  !!MIK-1!!
...
/**
 * Get the last function number in the protocol processor           !!MIK-1!!
 *                                                                  !!MIK-1!!
 * @return   6  = zadost o zapis 1 holding registru                 !!MIK-1!!
 * @return   16 = zadost o zapis vice holding registru              !!MIK-1!!
 * @return   3  = zadost o hodnoty v holding registrech             !!MIK-1!!
 * @return   4  = zadost o hodnoty v input registrech               !!MIK-1!!
 * @ingroup buffer                                                  !!MIK-1!!
 */                                              //                 !!MIK-1!!
uint8_t Modbus::getLastFunction()                //                 !!MIK-1!!
{                                                //                 !!MIK-1!!
    return lastFunction;                         //                 !!MIK-1!!
}                                                //                 !!MIK-1!!
